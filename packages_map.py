...
packages_map = {
    ...
    'amdgpu-pro-oglp':                         None,                                #we_have_already_combined_libgl_to_single_package
    ...
    'libegl1-amdgpu-pro-oglp':                 'amdgpu-pro-libgl',                  #mapped_manually
    'libegl1-amdgpu-pro-oglp:i386':            'lib32-amdgpu-pro-libgl',            #mapped_manually
    ...
    'libgles1-amdgpu-pro-oglp:i386':           None,                                #unneeded_open_component
    'libgles2-amdgpu-pro-oglp':                'amdgpu-pro-libgl',                  #mapped_manually
    'libgles2-amdgpu-pro-oglp:i386':           'lib32-amdgpu-pro-libgl',            #mapped_manually
