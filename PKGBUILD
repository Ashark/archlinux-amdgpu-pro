...
source=(progl::https://raw.githubusercontent.com/Ashark/archlinux-amdgpu-pro/master/progl
	...
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/a/amf-amdgpu-pro/amf-amdgpu-pro_1.4.29-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/liba/libamdenc-amdgpu-pro/libamdenc-amdgpu-pro_1.0-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libegl1-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_i386.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libegl1-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libgl1-amdgpu-pro-oglp-dri_${major_short}-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libgl1-amdgpu-pro-oglp-ext_${major_short}-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libgl1-amdgpu-pro-oglp-gbm_${major_short}-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libgl1-amdgpu-pro-oglp-glx_${major_short}-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libgles2-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_i386.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/o/oglp-amdgpu-pro/libgles2-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_amd64.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/v/vulkan-amdgpu-pro/vulkan-amdgpu-pro_${major_short}-1518373.${ubuntu_ver}_i386.deb
	https://repo.radeon.com/amdgpu/${branch}/ubuntu/pool/proprietary/v/vulkan-amdgpu-pro/vulkan-amdgpu-pro_${major_short}-1518373.${ubuntu_ver}_amd64.deb)
...
package_amf-amdgpu-pro () {
    ...
    extract_deb "${srcdir}"/amf-amdgpu-pro_1.4.29-1518373.${ubuntu_ver}_amd64.deb
    extract_deb "${srcdir}"/libamdenc-amdgpu-pro_1.0-1518373.${ubuntu_ver}_amd64.deb
...
package_amdgpu-pro-libgl () {
    ...
    extract_deb "${srcdir}"/libegl1-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_amd64.deb
    extract_deb "${srcdir}"/libgl1-amdgpu-pro-oglp-dri_${major_short}-1518373.${ubuntu_ver}_amd64.deb
    extract_deb "${srcdir}"/libgl1-amdgpu-pro-oglp-ext_${major_short}-1518373.${ubuntu_ver}_amd64.deb
    extract_deb "${srcdir}"/libgl1-amdgpu-pro-oglp-gbm_${major_short}-1518373.${ubuntu_ver}_amd64.deb
    extract_deb "${srcdir}"/libgl1-amdgpu-pro-oglp-glx_${major_short}-1518373.${ubuntu_ver}_amd64.deb
    extract_deb "${srcdir}"/libgles2-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_amd64.deb
    move_copyright
...
package_lib32-amdgpu-pro-libgl () {
    ...
    extract_deb "${srcdir}"/libegl1-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_i386.deb
    extract_deb "${srcdir}"/libgles2-amdgpu-pro-oglp_${major_short}-1518373.${ubuntu_ver}_i386.deb
    move_copyright
...
package_vulkan-amdgpu-pro () {
    ...
    extract_deb "${srcdir}"/vulkan-amdgpu-pro_${major_short}-1518373.${ubuntu_ver}_amd64.deb
    move_libdir "opt/amdgpu-pro/lib/x86_64-linux-gnu" "usr/lib"
    move_copyright
...
package_lib32-vulkan-amdgpu-pro () {
    ...
    extract_deb "${srcdir}"/vulkan-amdgpu-pro_${major_short}-1518373.${ubuntu_ver}_i386.deb
